...
public class OperatorInterface {
	...
	// m_prongDownButton.whenPressed(new
	// ProngsDown(Robot._prongsSubsystem));
	//
	// m_shootUpButton.whileHeld(new
	// ShooterOutTakeAbove(Robot.m_ShooterOutTakeSubsystem));
	// // m_shootUpButton.whenReleased(new
	// ShooterOutTakeSTOP(Robot.m_ShooterOutTakeSubsystem));
	//
	// m_shootDownButton.whileHeld(new
	// ShooterOutTakeBelow(Robot.m_ShooterOutTakeSubsystem));
	// // m_shootDownButton.whenReleased(new
	// ShooterOutTakeSTOP(Robot.m_ShooterOutTakeSubsystem));
	//
	// m_IntakeButton.whileHeld(new
	// ShooterInTake(Robot.m_ShooterInTakeSubsystem));
	// // m_IntakeButton.whenReleased(new
	// ShooterInTakeSTOP(Robot.m_ShooterInTakeSubsystem));
