 ...
 * 
 * enter* Methods attempt to change modes to the desired mode.
 * ENTERED means the state is newly acuired
 * CURRENT means you were already in the requested state
