...
public class RobotMap {
	...
	public static int driveDistanceButtonID = 9;
	public static int setRandomYawButtonID = 10;
	public static int disableHoldYawButtonID = 11;
	public static int fieldAbsoluteButtonID  = 12;
