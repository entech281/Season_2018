...
public class OI {
    ...
    // joystick button for the motionmagic, also tell it to move 18in both wheels
    private static JoystickButton m_MotionMagicButton = new JoystickButton(_driveJoystick, RobotMap.MotionMagicButton);
    ...
    public OI() {
        ...
        m_MotionMagicButton.whenPressed(new DriveToPositionCommand(Robot._driveSubsystem, new Position(120, 120)));
