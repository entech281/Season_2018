...
public class TalonEncoderStatus {
    ...
    public void updateEncoderStatus(WPI_TalonSRX talon ){
        updateEncoderStatus( talon.getSelectedSensorPosition(PID_SLOT), 
                             talon.getSelectedSensorVelocity(PID_SLOT),
                             talon.getControlMode(),
                             talon.getMotorOutputPercent());
    }

    public void updateEncoderStatus( int encoderPosition, int encoderVelocity, ControlMode mode, double motorCommandPercent ){
        this.mode = mode;
